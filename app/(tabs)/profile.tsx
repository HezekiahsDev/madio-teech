  ...
  const handleBiometricToggle = async (value: boolean) => {
    ...
    if (value) {
      ...
      if (!credentials) {
        Alert.alert(
          "Set up required",
          "Please sign out and sign in with your password once, then enable biometrics from the login prompt.",
        );
        return;
      }
      ...
      if (authResult.success) {
        ...
        Alert.alert(
          "Enabled",
          `${typeLabel} login and payment confirmation is now active.`,
        );
      } else {
        ...
        if (
          ...
          Alert.alert(
            "Failed",
            `${typeLabel} verification failed. Please try again.`,
          );
        }
      }
    } else {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.menuContainer}>
          <TouchableOpacity
            ...
            onPress={() => router.push("/(features)/account-settings")}
          >
          ...
          <TouchableOpacity
            style={styles.menuItem}
            onPress={() => router.push("/(features)/security-privacy")}
          >
            <View style={styles.menuIconContainer}>
      ...
      <View style={styles.legalSection}>
        <TouchableOpacity
          onPress={() => router.push("/(features)/privacy-policy")}
        >
          <Text style={styles.legalLink}>Privacy Policy</Text>
        </TouchableOpacity>
        <Text style={styles.legalDot}>·</Text>
        <TouchableOpacity
          onPress={() => router.push("/(features)/terms-conditions")}
        >
