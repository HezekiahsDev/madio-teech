    ...
    >
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.formGroup}>
          ...
          <TouchableOpacity style={styles.selectBox}>
            <Text style={styles.selectText}>{bundleType || "Select Bundle Type"}</Text>
            <ChevronDown size={20} color="#64748b" />
          </TouchableOpacity>
        </View>

        <View style={styles.formGroup}>
          <Text style={styles.label}>Bundle Amount</Text>
          <TouchableOpacity style={styles.selectBox}>
            <Text style={styles.selectText}>{bundleAmount || "Select Bundle Amount"}</Text>
            <ChevronDown size={20} color="#64748b" />
          </TouchableOpacity>
        </View>
        ...
        <TouchableOpacity style={styles.purchaseButton}>
          <Text style={styles.purchaseButtonText}>Proceed Purchase</Text>
        </TouchableOpacity>
